    ...
    func testStaticOperations() {
        ...
        for id in  1 ... 1000  {
            ...
            let plot = Plot(registerNumber: 1,
                            ...
                            realties: [],
                            gpsPossition: GpsPossition(lattitude: Double.random(in: 0 ... 10, using: &generator),
                                                       longitude: Double.random(in: 0 ... 10, using: &generator)),
                            id: id)
                    ...
                    for _ in 1 ... Int.random(in: 1 ... 8, using: &generator) {
                        realties.append(
                            Realty(registerNumber: Int.random(in: 1 ... 50, using: &generator),
                                   description: "something",
                                   plots: [],
                                   gpsPossition: GpsPossition(lattitude: Double.random(in: 0 ... 3, using: &generator),
                                                              longitude: Double.random(in: 0 ... 3, using: &generator)),
                                   id: y)
                        )
                    }
...
//            if y % 25000 == 0 { print(Double(y) / 10000.0, "%") }
            let plot = Plot(registerNumber: 1,
                            description: "asd",
                            realties: [],
